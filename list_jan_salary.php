                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group-sm">
                                                        ...
                                                        <select id="vehicle" onchange="csChange();" class="form-control input-sm">
                                                            ...
                                                            $sql2 = "select * from view_salary group by vehicle_ref";
                                                            ...
                                                            foreach ($conn->query($sql2) as $row) {
                                                                ...
                                                                $sqlDcount = "SELECT vehicle_number FROM view_salary where vehicle_ref = '" . $row['vehicle_ref'] . "'";
...
window.location.href = uri + base64(format(template, ctx))
                                                        ...
                                                        <script language="JavaScript" src="js/list_jan_salary.js"></script>
