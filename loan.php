<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Loan</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <a onclick="NewWindow('search_loan.php', 'mywin', '800', '700', 'yes', 'center');" class="btn btn-info btn-sm">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">OD Ref</label>
                        <div class="col-sm-2">
