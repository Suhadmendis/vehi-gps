<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Advance</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <a onclick="NewWindow('search_advance.php', 'mywin', '800', '700', 'yes', 'center');" class="btn btn-info btn-sm">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Advance Ref</label>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-3">
                            <input type="date" placeholder="Date" value="" id="date" class="form-control  input-sm">
                        </div>
                    </div>
