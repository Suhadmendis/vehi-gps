    ...
    <body>
        ...
        <table width="735"   class="table table-bordered">
            ...
            <tr>
                ...
                <td width="200" ><input type="text" size="70" id="customername3"  value=""  class="form-control" onkeyup="<?php echo "update_cust_list('$stname')"; ?>"/></td>
        </table>    
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                <tr>
                    <th width="110">Driver Ref</th>
                    <th width="200">Driver NIC</th>
                    <th width="200">Driver Number</th>
                ...
                //si_ref
                $sql = $sql . " order by driver_ref limit 50";
