                                            ...
                                            <input onkeyup="csChange();" class="form-control" value="<?php echo date('Y-m-d'); ?>" type="text" id="edate"></input><br>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group-sm">
                                                        ...
                                                        <select id="driver" onchange="csChange();" class="form-control input-sm">
                                                            <?php
                                                            include './connection_sql.php';

                                                            $sql2 = "select * from test_drvsal group by Driver_Ref_No";
                                                            ...
                                                            foreach ($conn->query($sql2) as $row) {
                                                                ...
                                                                $sqlDcount = "SELECT Driver_Name FROM test_drvsal where Driver_Ref_No = '" . $row['Driver_Ref_No'] . "'";
                                                                $result = $conn->query($sqlDcount);
                                                                $rowVname = $result->fetch();



                                                                echo '<option value=' . $row['Driver_Ref_No'] . '>' . $rowVname['Driver_Name'] . '</option>';
                                                            }
                                                            ?>
