...
function newent() {
    ...
    document.getElementById('fuel_ref').value = "";
...
function save_inv()
{
    ...
    if (document.getElementById('ltrs').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Amount Of Ltrs Not Enterd</span></div>";
        return false;
    }
     ...
     if (document.getElementById('voucher_no').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Voucher No Not Enterd</span></div>";
        return false;
    }
