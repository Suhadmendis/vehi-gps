...
function getdt() {
    ...
    var url = "search_brand_master_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if (stname === "Master") {
            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("brand_ref");
            opener.document.getElementById('brand_ref').value = XMLAddress1[0].childNodes[0].nodeValue;

            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("brand_id");
            opener.document.getElementById('brand_id').value = XMLAddress1[0].childNodes[0].nodeValue;
