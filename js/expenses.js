...
function newent() {
    ...
    document.getElementById('expense_ref').value = "";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('expense_ref').value = XMLAddress1[0].childNodes[0].nodeValue;
//
...
function save_inv()
{
    ...
    if (document.getElementById('expense_ref').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Exp. Ref Not Enterd</span></div>";
        return false;
    }
    
     if (document.getElementById('expense_category').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Expense Category Not Enterd</span></div>";
        return false;
    }
    ...
    url = url + "&expense_ref=" + document.getElementById('expense_ref').value;
    url = url + "&expense_category=" + document.getElementById('expense_category').value;
    ...
    url = url + "&entry_type=" + document.getElementById('entry_type').value;
