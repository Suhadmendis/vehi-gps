...
//        var stname = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('fuel_ref').value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_customername1");
        opener.document.getElementById('vehicle_ref').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('voucher_no').value = XMLAddress1[0].childNodes[0].nodeValue;


        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("dpt_name");
        opener.document.getElementById('vehicle_number').value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("fural_type");
        opener.document.getElementById('fuel_type_Text').value = XMLAddress1[0].childNodes[0].nodeValue;
