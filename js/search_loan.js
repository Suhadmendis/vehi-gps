...
//        var stname = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('od_ref').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('user').value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_customername5");
        opener.document.getElementById('monthes').value = XMLAddress1[0].childNodes[0].nodeValue;
