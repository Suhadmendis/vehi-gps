...
function newent() {
    ...
    document.getElementById('model_ref').value = "";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('model_ref').value = XMLAddress1[0].childNodes[0].nodeValue;
//
...
function save_inv()
{
    ...
    if (xmlHttp == null)
    {
     ...
     if (document.getElementById('model_ref').value == "") {
