...
function save_inv()
{
    ...
    if (document.getElementById('od_ref').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Deduction Ref No. Not Enterd</span></div>";
        return false;
    }
