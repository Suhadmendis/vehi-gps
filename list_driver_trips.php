                        ...
                        <br>
                            ...
                            <table id='myTable' class='table table-bordered'>
                                ...
                                <tbody>
                                    ...
                                    $sql = "select * from trip where driver_ref = 'DR/0000117'";
                                    ...
                                    foreach ($conn->query($sql) as $row) {
                                        ...
                                        echo "<td>" . 0 . "</td>";
                                        echo "<td>" . number_format($row['damount'], 2) . "</td>";
                                    ...
                                    echo "<td style='text-align: right;'><b>" . number_format($damount, 2) . "</b></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td style='text-align: right;'><b>" . number_format($BS, 2) . "</b></td>";
                                    echo "</tr>";

                                    //Q to get the ADVANCE

                                    $A = 2000;

                                    echo "<tr>";
                                    echo "<td colspan=4></td>";
                                    echo "<td>TOTAL ADVANCE</td>";
                                    echo "<td style='text-align: right;'><b>" . number_format($A, 2) . "</b></td>";
                                    echo "</tr>";

                                    //Q to get the DEDUCTION
                                    ...
                                    echo "<td style='text-align: right;'><b>" . number_format($D, 2) . "</b></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td colspan=4></td>";
                                    echo "<td>LOAN</td>";
                                    echo "<td style='text-align: right;'><b>" . number_format($L, 2) . "</b></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td colspan=4></td>";
                                    echo "<td>OD</td>";
                                    echo "<td style='text-align: right;'><b>" . number_format($OD, 2) . "</b></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td colspan=4></td>";
                                    echo "<td>EPF</td>";
                                    echo "<td style='text-align: right;'><b>" . number_format($EPF, 2) . "</b></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td style='text-align: right;'><b>" . number_format($NS, 2) . "</b></td>";
                                    echo "</tr>";
                                    
                                    echo "<tr>";
                                    echo "<td colspan=4></td>";
                                    echo "<td>NET SALARY</td>";
                                    echo "<td style='text-align: right;'><b>" . $next_month . "</b></td>";
                                    echo "</tr>";
                                    ?>
