...
if ($_GET["Command"] == "save_item") {
    ...
    $sql1 = "Insert into fuel(fuel_ref,vehicle_ref,vehicle_no,date,rate,ltrs,amount,voucher_no)values 
                        ('" . $_GET['fuel_ref'] . "','" . $_GET['vehicle_ref'] . "','" . $_GET['vehicle_no'] . "','" . $_GET['date'] . "','" . $_GET['rate'] . "','" . $_GET['ltrs'] . "','" . $_GET['amount'] ."','" . $_GET['voucher_no'] ."')";
